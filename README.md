<a href="examples/Goal.cys"><img align="center" width="100%" alt="Code" src="img/code.png"></a>
...
Cinyras is a [high level](https://en.wikipedia.org/wiki/High-level_programming_language) [general purpose](https://en.wikipedia.org/wiki/General-purpose_programming_language) [interpreted](https://en.wikipedia.org/wiki/Interpreted_language) programming language with its own [interpreter](https://en.wikipedia.org/wiki/Interpreter_(computing)) written in [Rust](https://github.com/rust-lang/rust).
